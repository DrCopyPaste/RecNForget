...
# Version
latest stable release: [0.6.2](https://github.com/DrCopyPaste/RecNForget/releases/latest).

- Currently developing: [0.6.x](https://github.com/DrCopyPaste/RecNForget/projects/4).
