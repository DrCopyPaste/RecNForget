...
public class SelectedFileService : ISelectedFileService
{
    ...
    protected virtual void OnSelectedFileChanged(SelectedFileServiceEventArgs e)
    {
        EventHandler<SelectedFileServiceEventArgs> handler = SelectedFileChanged;
        if (handler != null)
        {
            handler(this, e);
        }
    ...
    public bool HasSelectedFile { get { return SelectedFile != null && SelectedFile.Exists; } }
    ...
    public bool SelectFile(FileInfo file)
    {
        ...
        {
            SelectedFile = file;
            OnSelectedFileChanged(new SelectedFileServiceEventArgs(fileName: file.FullName));
    ...
    public bool SelectNextFile()
    {
        ...
        {
            OnSelectedFileChanged(new SelectedFileServiceEventArgs());
            return false;
        }
    }
